...
function Overview({ data, user, net, onBill, onPayment, onNudge, onBillDetail, onOpenBills }: { data: HouseholdData; user: User; net: number; onBill: () => void; onPayment: (context?: Balance) => void; onNudge: (item: Balance) => void; onBillDetail: (id: string) => void; onOpenBills: () => void }) {
